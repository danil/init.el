...
(require 'init-ansi-color "init-ansi-color") (init-ansi-color)
(require 'init-anzu "init-anzu") (init-anzu) (init-global-anzu-mode +1)
(require 'init-bash-completion "init-bash-completion") (init-bash-completion)
(require 'init-bindings "init-bindings") (init-global-bindings-mode +1)
(require 'init-browse-url "init-browse-url") (init-global-browse-url-mode +1)
(require 'init-bytecomp "init-bytecomp") (init-bytecomp)
(require 'init-calendar "init-calendar") (init-calendar)
(require 'init-cc-mode "init-cc-mode") (init-cc-mode)
(require 'init-clojure-mode "init-clojure-mode") (init-clojure-mode)
(require 'init-column-marker "init-column-marker") (init-column-marker)
(require 'init-csharp-mode "init-csharp-mode") ;; TODO: autoload
(require 'init-comint "init-comint") (init-comint)
(require 'init-compile "init-compile") (init-compile) (init-global-compile-mode +1)
(require 'init-conf-mode "init-conf-mode") (init-conf-mode)
(require 'init-corral "init-corral") (init-global-corral-mode +1) ;; smartparens replacement (quotes/parentheses/delimiters manager)
(require 'init-crontab-mode "init-crontab-mode") (init-crontab-mode)
(autoload 'init-css-mode-rainbow-identifiers-setup "init-css" nil t)
(require 'init-cycle-quotes "init-cycle-quotes") (init-global-cycle-quotes-mode +1)

;; Company mode auto complete.
(require 'init-company "init-company") (init-company) (init-global-company-mode +1)
(require 'init-company-css "init-company-css") (init-company-css)
(require 'init-company-elisp "init-company-elisp") (init-company-elisp)
(require 'init-company-erlang "init-company-erlang") (init-company-erlang)
(require 'init-company-inf-ruby "init-company-inf-ruby") (init-company-inf-ruby)
(require 'init-company-lua "init-company-lua") (init-company-lua)
(require 'init-company-nginx "init-company-nginx") (init-company-nginx)
(require 'init-company-shell "init-company-shell") (init-company-shell)
(require 'init-company-web "init-company-web") (init-company-web)

;; Counsel/Ivy/Swiper (is an ido replacement).
(require 'init-counsel "init-counsel") (init-counsel) (init-global-counsel-mode +1)
(require 'init-ivy-historian "init-ivy-historian") (init-ivy-historian)

;; Fringe <https://www.emacswiki.org/emacs/TheFringe>.
(require 'init-diff-hl "init-diff-hl") ;; TODO: autoload
(require 'init-fringe "init-fringe") (init-global-fringe-mode +1)

(require 'init-deft "init-deft") (init-global-deft-mode +1)
...
(require 'init-dired-aux "init-dired-aux") (init-dired-aux)
...
(require 'init-rainbow-mode "init-rainbow-mode") (init-rainbow-mode)

;; Selectrum a-la ido/ivy/counsel <https://github.com/raxod502/selectrum>.
(require 'init-selectrum "init-selectrum") (init-selectrum) (init-global-selectrum-mode +1) ;; a-la ido/ivy/counsel
(require 'init-selectrum-prescient "init-selectrum-prescient") (init-selectrum-prescient)
(require 'init-prescient "init-prescient") (init-prescient)
(amx-mode +1)

;; Mode line.
(require 'init-smart-mode-line "init-smart-mode-line") (init-smart-mode-line)
(require 'init-window-numbering "init-window-numbering") (init-window-numbering)

(require 'init-highlight-symbol "init-highlight-symbol") (init-highlight-symbol)
