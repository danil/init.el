...
(setq my-el-get-packages (append (mapcar 'el-get-source-name el-get-sources)))
...
(defun my-el-get (packages)
  (dolist (package packages)
    (add-to-list 'my-el-get-packages package)))

(my-el-get '(apache-mode))
(my-el-get '(auto-complete-emacs-lisp))
(my-el-get '(auto-complete-etags))
(my-el-get '(auto-complete-nxml))
(my-el-get '(browse-kill-ring))
(my-el-get '(crontab-mode))
(my-el-get '(csv-mode))
(my-el-get '(dash))
(my-el-get '(ebuild-mode))
(my-el-get '(findr))
(my-el-get '(jade-mode))
(my-el-get '(less-css-mode))
(my-el-get '(sass-mode))

(autoload '-difference "dash" nil t)

(my-recipes '(ag)) (my-el-get '(ag))
(my-recipes '(auto-complete ac-html)) (my-el-get '(ac-html))
(my-recipes '(auto-complete auto-complete-chunk)) (my-el-get '(auto-complete-chunk))
(my-recipes '(bash-completion)) (my-el-get '(bash-completion))
(my-recipes '(calendar))
(my-recipes '(cc-vars))
(my-recipes '(clojure-mode cider smartparens)) (my-el-get '(clojure-mode cider smartparens))
(my-recipes '(coffee-mode)) (my-el-get '(coffee-mode))
(my-recipes '(column-marker)) (my-el-get '(column-marker))
(my-recipes '(compile))
(my-recipes '(conf-mode))
(my-recipes '(css))
(my-recipes '(deft)) (my-el-get '(deft))
(my-recipes '(desktop))
(my-recipes '(diff-mode))
(my-recipes '(dired dired-reuse-directory-buffer))
(my-recipes '(dired direx)) (my-el-get '(direx))
(my-recipes '(discover-my-major)) (my-el-get '(discover-my-major))
(my-recipes '(disp-table))
(my-recipes '(dockerfile-mode)) (my-el-get '(dockerfile-mode))
(my-recipes '(ediff))
(my-recipes '(emacs-lisp-mode))
(my-recipes '(env))
(my-recipes '(erise)) (my-el-get '(erise))
(my-recipes '(etags-select)) (my-el-get '(etags-select))
(my-recipes '(ethan-wspace)) (my-el-get '(ethan-wspace))
(my-recipes '(expand-region)) (my-el-get '(expand-region))
(my-recipes '(ferm-mode)) (my-el-get '(ferm-mode))
(my-recipes '(files))
(my-recipes '(files-backup))
(my-recipes '(fill))
(my-recipes '(fiplr)) (my-el-get '(fiplr))
(my-recipes '(fish-mode)) (my-el-get '(fish-mode))
(my-recipes '(git-gutter)) (my-el-get '(git-gutter))
(my-recipes '(git-timemachine)) (my-el-get '(git-timemachine))
(my-recipes '(gitignore-mode)) (my-el-get '(git-modes))
(my-recipes '(haml-mode)) (my-el-get '(haml-mode)) ;depends from ruby-mode due to ruby-toggle-hash-syntax
(my-recipes '(helm helm-ag)) (my-el-get '(helm-ag))
(my-recipes '(helm helm-descbinds)) (my-el-get '(helm-descbinds))
(my-recipes '(helm helm-git-grep)) (my-el-get '(helm-git-grep))
(my-recipes '(helm helm-ls-git)) (my-el-get '(helm-ls-git))
(my-recipes '(helm helm-swoop)) (my-el-get '(helm-swoop))
(my-recipes '(help))
(my-recipes '(help-mode))
(my-recipes '(hi-lock))
(my-recipes '(hideshow))
(my-recipes '(highlight-current-line))
(my-recipes '(highlight-symbol)) (my-el-get '(highlight-symbol))
(my-recipes '(ibuffer))
(my-recipes '(ido ido-preview)) (my-el-get '(ido-preview))
(my-recipes '(ido ido-ubiquitous)) (my-el-get '(ido-ubiquitous))
(my-recipes '(ido ido-vertical-mode)) (my-el-get '(ido-vertical-mode))
(my-recipes '(ido ido-yes-or-no)) (my-el-get '(ido-yes-or-no))
(my-recipes '(ido kill-ring-ido)) (my-el-get '(kill-ring-ido))
(my-recipes '(ido recentf recentf-ido-find-file))
(my-recipes '(ielm))
(my-recipes '(indent))
(my-recipes '(indent-guide)) (my-el-get '(indent-guide))
(my-recipes '(info))
(my-recipes '(interprogram))
(my-recipes '(isearch))
(my-recipes '(js-mode js2-mode)) (my-el-get '(js2-mode))
(my-recipes '(json-mode json-reformat)) (my-el-get '(json-mode json-reformat))
(my-recipes '(kill-emacs))
(my-recipes '(kill-ring))
(my-recipes '(linum linum-format))
(my-recipes '(lisp-mode))
(my-recipes '(lua-mode)) (my-el-get '(lua-mode))
(my-recipes '(magit magit-blame)) (my-el-get '(magit))
(my-recipes '(make-mode))
(my-recipes '(markdown-mode)) (my-el-get '(markdown-mode))
(my-recipes '(multiple-cursors)) (my-el-get '(multiple-cursors))
(my-recipes '(my-backspace-fix))
(my-recipes '(my-beginning-of-line))
(my-recipes '(my-color-theme))
(my-recipes '(my-project))
(my-recipes '(my-tags))
(my-recipes '(nginx-mode)) (my-el-get '(nginx-mode))
(my-recipes '(nodejs-repl)) (my-el-get '(nodejs-repl))
(my-recipes '(nvm)) (my-el-get '(nvm))
(my-recipes '(occur-mode))
(my-recipes '(org-mode org-reveal)) (my-el-get '(org-reveal))
(my-recipes '(org-mode)) (my-el-get '(org-mode))
(my-recipes '(paren))
(my-recipes '(password-cache))
(my-recipes '(point-stack)) (my-el-get '(point-stack))
(my-recipes '(pomohist))
(my-recipes '(pretty-lambdada)) (my-el-get '(pretty-lambdada))
(my-recipes '(quickrun)) (my-el-get '(quickrun))
(my-recipes '(rainbow-delimiters)) (my-el-get '(rainbow-delimiters))
(my-recipes '(rainbow-mode)) (my-el-get '(rainbow-mode))
(my-recipes '(rbenv)) (my-el-get '(rbenv))
(my-recipes '(re-builder))
(my-recipes '(recentf))
(my-recipes '(ruby-mode rinari)) (my-el-get '(rinari))
(my-recipes '(ruby-mode rspec-mode rspec-compilation-mode)) (my-el-get '(ruby-hash-syntax rspec-mode))
(my-recipes '(ruby-mode ruby-pry)) (my-el-get '(ruby-pry))
(my-recipes '(ruby-mode ruby-refactor)) (my-el-get '(ruby-refactor))
(my-recipes '(ruby-mode ruby-tools)) (my-el-get '(ruby-tools))
(my-recipes '(ruby-mode)) (my-el-get '(ruby-hash-syntax))
(my-recipes '(savehist))
(my-recipes '(saveplace))
(my-recipes '(scss-mode)) (my-el-get '(scss-mode))
(my-recipes '(sgml-mode))
(my-recipes '(sh-script))
(my-recipes '(shell))
(my-recipes '(simp)) (my-el-get '(simp))
(my-recipes '(simple))
(my-recipes '(smart-mode-line rich-minority)) (my-el-get '(smart-mode-line rich-minority))
(my-recipes '(smex)) (my-el-get '(smex))
(my-recipes '(sort))
(my-recipes '(sql-postgres))
(my-recipes '(subword-mode))
(my-recipes '(undo-tree)) (my-el-get '(undo-tree))
(my-recipes '(uniquify))
(my-recipes '(web-mode)) (my-el-get '(web-mode))
(my-recipes '(window))
(my-recipes '(window-numbering)) (my-el-get '(window-numbering))
(my-recipes '(winner-mode))
(my-recipes '(yaless-mode))
(my-recipes '(yaml-mode)) (my-el-get '(yaml-mode))
(my-recipes '(yascroll)) (my-el-get '(yascroll))
(my-recipes '(yasnippet yasnippets)) (my-el-get '(yasnippet yasnippets))

;;; Install/remove my packages (see above).
(el-get-cleanup my-el-get-packages) ;remove all packages absent from `my-el-get-packages'
