(custom-set-variables
 ...
 '(init-projectile-mode-hooks (append init-programming-modes-hooks '(dired-mode-hook shell-mode-hook sql-interactive-mode-hook magit-process-mode-hook magit-revision-mode-hook magit-status-mode-hook))) ;; init-projectile.el
