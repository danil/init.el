(custom-set-variables
 ...
 '(init-projectile-mode-hooks (append init-programming-modes-hooks '(dired-mode-hook go-test-mode-hook ivy-occur-grep-mode-hook magit-diff-mode-hook magit-process-mode-hook magit-revision-mode-hook magit-stash-mode-hook magit-status-mode-hook shell-mode-hook sql-interactive-mode-hook))) ;; init-projectile.el
